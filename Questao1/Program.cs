...
public static class Program
{
    public static void Main(string[] args)
    {
        ...
        var resp = char.Parse(Console.ReadLine() ?? "N");
        
        if (resp is 's' or 'S')
        {
            Console.Write("Entre o valor de depósito inicial: ");
            var depositoInicial = double.Parse(Console.ReadLine() ?? "0.0", CultureInfo.InvariantCulture);
        ...
        var quantia = double.Parse(Console.ReadLine() ?? "0.0", CultureInfo.InvariantCulture);
        ...
        quantia = double.Parse(Console.ReadLine() ?? "0.0", CultureInfo.InvariantCulture);
        conta.Saque(quantia);
        Console.WriteLine("Dados da conta atualizados:");
        Console.WriteLine(conta);
